 ...
 */
public record SignUpViewController(
    ...
    public void routing(HttpRules rules) {
        rules
                // Pages
                .get(this::showSignUpForm)
                // Actions
                .post(this::submitSignUpForm);
    }

    // ============= PAGES (Queries) =============

    private void showSignUpForm(ServerRequest req, ServerResponse res) {
    ...
    private void submitSignUpForm(ServerRequest req, ServerResponse res) {
        try {
            ...
            Session session = signUpHandler.handle(command);
